export default function DrawCards({ example, index, handleClick }) {
  return (
    <div
      key={index}
      className="m-3 flex-wrap max-w-md rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-700 mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-5"
    >
